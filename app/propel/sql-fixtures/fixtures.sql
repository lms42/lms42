...
INSERT INTO `tasks` (`id`, `lesson_id`, `title`, `text`, `file`, `solution`, `created_at`, `updated_at`, `sortable_rank`)
VALUES
	(1,1,'Калькулятор','Напишите программу, которая вычисляет 2 в степени 100, 3 в степени 50, 2+2*2, корень из 3. В ответе, помимо текста самой программы, укажите результат выполнения программы.&nbsp;',NULL,NULL,'2012-09-02 22:40:31','2012-09-02 22:40:31',1),
	(2,1,'Смена переменных','Даны две переменные типа integer: <i>a</i> и <i>b</i>. Напишите программу, которая без создания дополнительной переменной меняет их значения местами, то есть переменная&nbsp;<i>a</i> становится равной <i>b<b></b></i><b></b>, а&nbsp;<i>b</i> —&nbsp;<b></b><i>a</i>. Если вы не можете придумать решение, укажите хотя бы ваши идеи.',NULL,NULL,'2012-09-02 22:42:04','2012-09-02 22:42:04',2),
	(3,2,'Сравнения','Напишите программу, которая сравнивает два числа: 2 в степени 100 и 3 в степени 50. Программа должна выводить слово \"больше\", если первое число больше второго, \"равно\" — если числа равны, \"меньше\" — если первое число меньше второго. Сами числа выводить не нужно.',NULL,NULL,'2012-09-02 22:44:00','2012-09-02 22:44:00',1),
	(4,3,'Формула Хартли','Задана переменная N (типа integer), в которой хранится количество символов некоего алфавита, неизвестно какого. Напишите программу, которая посчитает, какое минимальное количество&nbsp;бит может занимать один символ данного алфавита. В ответе программа должна выводить только число — количество бит.',NULL,NULL,'2012-09-02 22:46:40','2012-09-02 22:46:40',1),
	(5,3,'Числа Фибоначчи','Напишите программу, вычисляющую N-ное число Фибоначчи (N задаётся в виде переменной в начале программы) с помощью цикла whilte. Вычислите 100-ое число Фибоначчи с помощью программы и сравните результат с программой, указанной в презентации.<br><br>Дополнительно укажите, какая из программ вам кажется более удачной и почему?<br><br>В ответе нужно написать:<br><ul><li>программу с циклом while,</li><li>два значения: 100-ое число Фибоначчи, вычисленное обеими программами,</li><li>мнение насчёт явного и неявного циклов.</li></ul>',NULL,NULL,'2012-09-02 22:48:41','2012-09-02 22:48:41',2),
	(6,4,'Произведение элементов','Напишите программу, которая с помощью метода inject вычисляет произведение элементов массива. В качестве массива можно использовать любой набор целых чисел, задаваемый в начале программы.',NULL,NULL,'2012-09-02 22:49:47','2012-09-02 22:49:47',1),
	(7,4,'Средние','Напишите программу, которая для заданного в начале программы массива натуральных чисел вычисляет:<br><ul><li>среднее арифметическое элементов массива,</li><li>среднее геометрическое элементов массива,</li><li>среднее гармоническое элементов массива.</li></ul>',NULL,NULL,'2012-09-02 22:50:44','2012-09-02 22:50:44',2),
	(8,4,'Поиск элементов','Задан массив из 10 целых чисел (любых). Напишите программу, которая с помощью метода find_all выводит на экран все элементы массива, меньшие нуля и делящиеся на 3.',NULL,NULL,'2012-09-02 22:51:54','2012-09-02 22:51:54',3),
	(9,4,'Поиск и сумма','Задан массив из 10 целых чисел (любых). Напишите программу, которая выводит на экран сумму всех чётных положитительных элементов массива.',NULL,NULL,'2012-09-02 22:52:38','2012-09-02 22:52:38',4),
	(10,5,'Длина слов','Задана строка <i>s</i>. Напишите программу, вычисляющую среднюю длину слова.<br><br><b>Пояснение:</b> <i>средняя длина слова в строке — это среднее арифметическое длин всех слов строки.</i><br><br><b>Пример:</b><br>Дана строка: \"Мама мыла раму доместосом\".<br>Средняя длина слова: (4+4+4+10)/4 = 5.5 символов.<br>Ответ: 5.5',NULL,NULL,'2012-09-02 22:54:57','2012-09-02 22:54:57',1),
	(11,5,'Палиндромы','Дана строка <i>s</i>. Напишите программу, выводящую на экран все слова-палиндромы, встречающиеся в строке.<br><br><b>Пояснение</b><br>Палиндромом называют слово (или словосочетание), одинаково читающееся в обоих направлениях.<br><br><b>Примеры:</b><br><ul><li>топот,</li><li>анна,</li><li>А роза упала на лапу Азора.</li></ul>',NULL,NULL,'2012-09-02 22:56:28','2012-09-02 22:56:28',2),
	(12,5,'Сложные палиндромы','Дана строка <i>s</i>. Напишите программу, выводящую на экран все палиндромы, находящиеся в данной строке (включая палиндромы-словосочетания).<br><br><b>Комментарий</b><br>Если вы не можете решить эту задачу, в ответе укажите идеи насчёт решения.',NULL,NULL,'2012-09-02 22:57:34','2012-09-02 22:57:34',3),
	(13,6,'451 градус по Фаренгейту','Напишите функцию, которая переводит градусы по Фаренгейту в градусы по Цельсию. С помощью функции найдите, чему равен 451 градус по Фаренгейту в Цельсиях и укажите это число в ответе. <br><br>Дополнительно поясните, откуда взялось вообще число 451.&nbsp;<br><br>Ответ должен содержать 3 части:<br><ul><li>функция перевода градусов,</li><li>значение 451 градуса по Фаренгейту в Цельсиях,</li><li>объяснение, откуда взялось число 451.&nbsp;<br></li></ul>',NULL,NULL,'2012-09-02 23:00:52','2012-09-02 23:00:52',1),
	(14,7,'Взаимно-простые числа','Дано натуральное число <i>a</i>. Выведите на экран все числа, которые взаимно просты с <i>a</i> и не превышают некоего числа N, заданного в начале программы.<br><br><b>Пример</b><br>N = 10<br>a = 3<br>Программа должна вывести все числа, меньшие либо равные&nbsp;10 и взаимно простые с 3. Таких чисел шесть: 2, 4, 5, 7, 8, 10.',NULL,NULL,'2012-09-02 23:02:46','2012-09-02 23:02:46',1),
	(15,7,'Ханойские башни','Напишите программу, которая выводит на экран алгоритм решения задачи о Ханойских башнях для заданного количества колец N (N задаётся в начале программы).<br><br><b>Дополнительно</b> решите следующую задачу:<br>Предположим, что на перекладывание одного кольца монахи тратят 1 минуту. Посчитайте, сколько потребуется монахам времени, чтобы выполнить условие Брахмы для конца света.',NULL,NULL,'2012-09-02 23:05:46','2012-09-02 23:05:46',2),
	(16,8,'Задача о коммивояжёре','Коммивояжёру для продажи своего товара нужно посетить несколько городов. Некоторые города соединены дорогами. Напишите самый простой жадный алгоритм, который бы выбрал коммивояжёру кратчайший путь из возможных.<br><br><b>Замечание</b><br>В данном задании не требуется:<br><ul><li>Написать программу. Достаточно только алгоритма.</li><li>Найти самый-самый короткий путь. Ваша цель — предложить рабочий алгоритм, использующий жадный принцип выбора.</li></ul>',NULL,NULL,'2012-09-02 23:08:44','2012-09-02 23:08:44',1),
	(17,9,'Резюме','Напишите краткое резюме, что вы поняли из презентации по паттернам программирования. Выделите те моменты, которые показались вам наиболее актуальными, и <b>объясните</b>, почему.',NULL,NULL,'2012-09-02 23:11:36','2012-09-02 23:11:36',1),
	(18,10,'Повторение слов','Задана строка <i>s</i>. Выведите на экран 10 наиболее встречающихся слов в строке.<br><br><b>Замечание</b><br>Для проверки в этой задаче рекомендуется вводить достаточно большой кусок текста. Взять его можно из любой книги, например, из Войны и Мира.',NULL,NULL,'2012-09-02 23:13:01','2012-09-02 23:13:01',1),
	(19,10,'Парсинг данных','Задан кусок вывода одной из метеорологических служб в виде строковой переменной <i>s</i> в следующем формате: весь текст состоит из строк (количество строк неизвестно), каждая строка состоит из:<br><ol><li>Даты в следующем формате: <i>число</i> (одна или&nbsp;две цифры), затем символ&nbsp;<i>точка</i>, затем <i>месяц</i> (одна или две цифры). Пример: 13.02</li><li>Символ <i>пробела</i> после даты.</li><li>Температуры в виде вещественного числа: 15.23. Дробная часть отделена от целой запятой.</li></ol>Пример входной строки <i>s</i>:<br>13.02 -22.5<br>14.01 -5.9<br>18.02 -9.5<br>15.04 2.3<br>17.05 10.4<br>18.06 22.2<br>01.01 -10.1<br><br><b>Задание</b><br>Вывести на экран среднемесячные температуры за каждый месяц в формате \"<i>номер месяца</i> пробел <i>средняя температура</i>). Если для данного месяца данные отсутствуют — вывести \"<i>номер месяца </i>пробел <i>данные отсутствуют</i>).<i> </i>Месяцы выводить в порядке возрастания, начиная с января (01).<br><br>Пример вывода:<br>01 -8.0<br>02 -16.0<br>03 данные отсутствуют<br>04 2.3<br>05 10.4<br>06 22.2<br>07 данные отсутствуют<br>08&nbsp;данные отсутствуют<br>09&nbsp;данные отсутствуют<br>10&nbsp;данные отсутствуют<br>11&nbsp;данные отсутствуют<br>12&nbsp;данные отсутствуют',NULL,NULL,'2012-09-02 23:21:04','2012-09-02 23:21:04',2),
	(20,11,'Приоритет','<p>Расставьте минусы информационного общества в порядке их важности (согласно вашим представлениям) и объясните, почему вы расставили именно так.</p>',NULL,NULL,'2013-08-05 13:01:03','2013-08-05 13:01:26',1),
	(21,11,'Плюсы и минусы','<p>Дополните список плюсов и минусов информационного общества своими примерами, три (или больше) плюса и три (или больше) минуса.</p>',NULL,NULL,'2013-08-05 13:01:44','2013-08-05 13:01:44',2);
